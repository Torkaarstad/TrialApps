...
namespace DataStructures.Tests
{
    ...
    {
        [TestMethod]
        public void CB_New_Buffer_Is_Empty()
        {
        ...
        [TestMethod]
        public void CB_Three_Element_Buffer_Is_Full_After_Three_Writes()
        {
        ...
        [TestMethod]
        public void CB_First_In_First_Out_When_Not_Full()
        {
        ...
        [TestMethod]
        public void CB_Overwrites_When_More_Than_Capacity()
        {
            var buffer = new CircularBuffer<double>(capacity: 3);
