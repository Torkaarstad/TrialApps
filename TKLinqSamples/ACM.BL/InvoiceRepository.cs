...
namespace ACM.BL
{
    public class InvoiceRepository
    {
        ...
        {
            var query = invoiceList.GroupBy(inv => inv.IsPaid ?? false, //?? if it is null then it should be false
                                            inv => inv.TotalAmount,
        ...
        //GroupBy - returns dynamic just for the test. Not recommonded in real use.
        public dynamic GetInvoiceTotalByIsPaidAndMonth(List<Invoice> invoiceList)
        {
            var query = invoiceList.GroupBy(inv => new //TK_ Our key is an ananmous type
            {
